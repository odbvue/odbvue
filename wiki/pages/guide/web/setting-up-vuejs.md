...
[Oxlint](https://oxc.rs/docs/guide/usage/linter.html) is a fast linter for JavaScript and TypeScript that identifies potential problems in code.

### Oxfmt

[Oxfmt](https://oxc.rs/docs/guide/usage/formatter.html) is a code formatter that keeps code consistently written throughout the project.
