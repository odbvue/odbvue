...
Building and operating application requires a diverse range of skills and knowledge. It is not possible for a small team or individual to be able to cover all the areas, but the key factor of success is to know the concepts and be capable to ask AI the right questions.

Embrace the **learning journey** and continuously refine your knowledge to **get the thing done**.
...
[Best Frontend Frameworks for Web Development in 2023](https://www.simform.com/blog/best-frontend-frameworks/)
...
Modern applications often run on cloud platforms such as AWS, Azure, or Google Cloud. Understanding the basic building blocks of cloud infrastructures – compute, storage, networking, managed databases, and identity & access management – helps you design scalable and reliable systems, and make informed cost/performance trade‑offs.

[Cloud service comparison](https://www.oracle.com/cloud/service-comparison/)

### Infrastructure as Code (IaC)

Infrastructure as Code is the practice of describing and provisioning infrastructure (servers, networks, databases, permissions) using declarative code instead of manual clicks in a UI. Learning tools like Terraform, Pulumi, or cloud‑native templates (ARM/Bicep, CloudFormation) enables repeatable, version‑controlled environments and safer deployments.
...
Designing and building a web application requires not only technical skills but also certain habits and practices that contribute to a successful development process. Here are the most crucial.
...
### The rational depth of up-front planning

Up-front planning is necessary, but only to the depth that matches the time horizon. Near-term work should be concrete and executable, while longer-term plans should stay broader, directional, and open to change. A day may need specific tasks, a week may need a small set of priorities, a month may define a target, and a quarter or year should capture intent rather than detailed step-by-step execution.

This non-linear approach to planning keeps teams focused on what can be done now without losing sight of why the work matters in the first place. It also avoids the common failure of over-planning distant work that will inevitably change before it is reached.
