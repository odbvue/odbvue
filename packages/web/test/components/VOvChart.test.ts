...
import VOvChart from '../../src/components/data/VOvChart.vue'

vi.mock('vue-chartjs', () => ({
  Bar: { name: 'Bar', template: '<div />' },
  Line: { name: 'Line', template: '<div />' },
  Pie: { name: 'Pie', template: '<div />' },
  Doughnut: { name: 'Doughnut', template: '<div />' },
  Radar: { name: 'Radar', template: '<div />' },
  PolarArea: { name: 'PolarArea', template: '<div />' },
  Scatter: { name: 'Scatter', template: '<div />' },
}))
