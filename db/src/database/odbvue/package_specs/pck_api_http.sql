create or replace 
PACKAGE ODBVUE.pck_api_http AS -- Package for HTTP call processing
...
-- sqlcl_snapshot {"hash":"142d9d3338408911f3f55324e6fefec0ca6775e9","type":"PACKAGE_SPEC","name":"PCK_API_HTTP","schemaName":"ODBVUE","sxml":""}