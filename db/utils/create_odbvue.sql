                            ...
                            'columns' VALUE (
                                SELECT JSON_ARRAYAGG(
                                    JSON_OBJECT(
                                        ...
                                        'identity' VALUE identity_column
                                    )
    ...
    BEGIN
        ...
        FOR i IN 0 .. v_tables.get_size() - 1 LOOP
            ...
            FOR j IN 0 .. v_columns.get_size() - 1 LOOP
                ...
                v_col_nullable := v_column.get_String('nullable');
                v_col_identity := v_column.get_String('identity');

                IF v_col_identity = 'YES' THEN
